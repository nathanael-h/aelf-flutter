...
class NoneView extends StatefulWidget {
  const NoneView({
    super.key,
  ...
  @override
  State<NoneView> createState() => _NoneViewState();
}

class _NoneViewState extends State<NoneView> {
  ...
  @override
  void didUpdateWidget(NoneView oldWidget) {
...
class _NoneOfficeDisplay extends StatelessWidget {
  const _NoneOfficeDisplay({
  ...
  List<Widget> _buildTabViews() {
    ...
    views.addAll([
      _ReadingTab(hourOffice: officeData.none),
