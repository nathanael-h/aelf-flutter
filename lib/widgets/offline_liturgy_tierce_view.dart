...
class TierceView extends StatefulWidget {
  const TierceView({
    super.key,
  ...
  @override
  State<TierceView> createState() => _TierceViewState();
}

class _TierceViewState extends State<TierceView> {
  ...
  @override
  void didUpdateWidget(TierceView oldWidget) {
...
class _TierceOfficeDisplay extends StatelessWidget {
  const _TierceOfficeDisplay({
  ...
  List<Widget> _buildTabViews() {
    ...
    views.addAll([
      _ReadingTab(hourOffice: officeData.tierce),
