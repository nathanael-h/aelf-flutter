...
/// Dedicated tab for the Invitatory (Morning office)
class InvitatoryTab extends StatefulWidget {
  const InvitatoryTab({
    super.key,
  ...
  @override
  State<InvitatoryTab> createState() => _InvitatoryTabState();
}

class _InvitatoryTabState extends State<InvitatoryTab> {
  ...
  Widget _buildPsalm(String psalmKey, List<String>? antiphons) {
    final psalm = widget.resolved.psalmsCache[psalmKey];
    if (psalm == null) {
      return const Text('Psaume non trouvé');
    }
