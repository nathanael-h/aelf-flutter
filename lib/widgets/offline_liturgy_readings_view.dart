...
class _BiblicalReadingTab extends StatelessWidget {
  ...
  Widget _buildBiblicalReading(BiblicalReading reading,
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        if (reading.title != null) LiturgyPartTitle(reading.title!),
...
class _OrationTab extends StatelessWidget {
  ...
  List<Widget> _buildOrationContent(List<String>? orations, double zoom) {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        SizedBox(height: 12.0 * zoom / 100),
        ..._buildOrationContent(readingsData.oration, zoom),
