    ...
    var popUp = AlertDialog(
      ...
      content: SingleChildScrollView(
          child: Linkify(
              ...
              text:
                  "Cette fonctionnalité (\"$feature\") n'est pas encore développée. Cette application est libre🆓 et open source🔓, et le développement 👨‍💻 est encore en cours🚧. Toute aide est la bienvenue ! 🙂 🎉 💪 Voyez cette page :\n👉🏼 https://gitlab.com/nathanael2/aelf-flutter ")),
    );
