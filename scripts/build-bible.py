...
def index_path(
    chapter_file_path, book_ref, book_id, book_title, chapter_ref, chapter_title
):
    global chapter_id
...
# Index all chapters
cursor.execute(
    """INSERT INTO search(book, book_id, chapter, rowid, title, text) SELECT book, book_id, chapter, chapter_id, title, text FROM chapters;"""
)
